...
test('throw if supplied options is not an object', function (t) {
    t.throws(function() {
        new KeyTree('|');
    }, TypeError);
    t.end();
...
test('check that an object is passed as options, or non at all', function (t) {
...
test('a different `separator` should be respected', function (t) {
    var tree = new KeyTree({ separator: '|' });
    var one = {id: 'one'};
    var two = {id: 'two'};
    var three = {id: 'three'};
    var four = {id: 'four'};
